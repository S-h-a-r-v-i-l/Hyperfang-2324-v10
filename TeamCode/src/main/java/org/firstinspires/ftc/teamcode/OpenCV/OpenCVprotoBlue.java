...
public class OpenCVprotoBlue extends OpMode {
    ...
    public void start() {
        ...
        if (zone == 1) { //left
            ...
            fr.setPower(0);
            sleep(1000);
            fl.setTargetPosition(480);
            bl.setTargetPosition(480);
            br.setTargetPosition(1680);
            fr.setTargetPosition(1680);
            fl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            bl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            br.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            fr.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            if (zone == 2) { //middle
                ...
                fr.setPower(0);
                sleep(250);*/
                fl.setTargetPosition(885);
                bl.setTargetPosition(885);
                br.setTargetPosition(885);
                fr.setTargetPosition(885);
                fl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                bl.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                br.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                fr.setMode(DcMotor.RunMode.RUN_TO_POSITION);
