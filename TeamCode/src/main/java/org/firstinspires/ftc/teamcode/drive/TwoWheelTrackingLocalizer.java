...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.55957803861; // Multiplier in the X direction
    public static double Y_MULTIPLIER = -0.830298842; // Multiplier in the Y direction
